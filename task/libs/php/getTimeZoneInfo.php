...
} elseif (!isset($decode['timezoneId']) || !isset($decode['countryName']) || !isset($decode['time'])) {
    $output['status']['code'] = "204";  
    $output['status']['name'] = "no content";
    $output['status']['description'] = "No valid timezone data found for the provided coordinates.";
    $output['data'] = null;
} else {
